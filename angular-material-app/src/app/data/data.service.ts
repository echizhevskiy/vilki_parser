...
export class DataService {
  ...
  ELEMENT_DATA: Post[] = [
    ...
    {position: 6, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 7, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 8, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 9, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 10, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 11, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
    {position: 12, title: 'Post Six', category: 'Web Development', date_posted: new Date(), body: 'Body 6'},
  ];
  categories = [
