            ...
            def parse
                Headless.ly do
                    browser = Watir::Browser.new
                        ...
                        event_data = []
                        bet_data = []
                        browser.goto('https://www.leon.ru/events/IceHockey/region/1970324836974837-Poland')
                            ...
                            doc.css('div.content div.fon div.body div.main span').each do |main|
                                main.css('li.expanded').each do |data|
                                        ...
                                        event_data = Event.new(
                                                            ...
                                                            home_team: teams[0],
                                                            guest_team: teams[1],
                                                            match_kind: 'PHL' #main.css('div.head-title div.middle a').text.strip.delete(' ').gsub(/,.*/, '').gsub(/-.*-/, '.')                              
                                                            )
